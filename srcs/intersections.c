...
// Sets the closest intersection and its shape between closest and current
...
// Finds the closest intersection point with the ray
// Searches through all the objects in the scene
...
// calculates the normal (vector direction) between shape and camera
